...
import net.sourceforge.ecm.repository.FedoraUserToken;
 ...
 * @see net.sourceforge.ecm.repository.FedoraUserToken
 * @see net.sourceforge.ecm.repository.Repository
 */
public class Initializer
    ...
    private static final String DEFAULT_CONNECTOR = "net.sourceforge.ecm.repository.FedoraSoapImpl";
    private String pidgenerator;

    private static final Log LOG = LogFactory.getLog(Initializer.class);
    private static final String DEFAULT_PIDGENERATOR = "net.sourceforge.ecm.repository.PidGeneratorImpl";
